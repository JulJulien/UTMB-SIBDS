...
sig_antisense_wt0wt6_bp <- ggplot(sig_antisense_wt0wt6, aes(x = reorder(gene_name, wt0wt6), y = wt0wt6, fill = gene_name)) +
  ...
  labs(
    x = "Gene",
    y = "WT @ 0h vs WT @ 6h",
    title = "Plot of Antisense Gene Expression for WT @ 0h vs WT @ 6h"
  )

#Save plot as png
ggsave("antisense_wt0wt6_sig_bp.png", plot = sig_antisense_wt0wt6_bp, bg = "white", width = 8, height = 12, dpi = 300)

#Save subset as excel
write_xlsx(sig_antisense_wt0wt6, "sig_antisense_wt0wt6.xlsx")
getwd()
#-----------------
...
--------------------
Significant Decreases by Gene Type
--------------------
``` {r decgenetype}
```
